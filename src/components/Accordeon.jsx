...
function Accordeon(props) {
  ...
  return (
    <div className='max-w-[350px] w-full' onMouseEnter={toggle} onMouseLeave={toggle}>
        <p className='px-[15px] py-[5px] flex items-center justify-between capitalize border-b border-primary text-base cursor-pointer'>
            {props.title}
